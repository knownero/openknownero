...
string                  CurrentBlockchainStatus::blockchain_path{"~/.blockchain/lmdb"};
string                  CurrentBlockchainStatus::deamon_url{"http:://127.0.0.1:4368"};
...
uint64_t                CurrentBlockchainStatus::import_fee {100}; // 0.01 xmr
